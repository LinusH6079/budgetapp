        ...
        <div className="app-panel px-4 py-4 sm:px-5">
          ...
          <div className="mt-4 space-y-3 text-sm">
            <p className="surface-card py-3">
              Plan kvar <strong>{formatCurrency(summary.remainingPlanned)}</strong>
            </p>
            <p className="surface-card py-3">
              Obetalda <strong>{summary.unpaidCount}</strong>
            </p>
            <p className="surface-card py-3">
              Försenade <strong>{summary.overdueExpensesCount}</strong>
            </p>
            <p className="surface-card py-3">
              Diff{" "}
              <strong>
