  ...
  return (
    <section className="grid gap-4 lg:grid-cols-2">
      <div className="app-panel px-5 py-5 sm:px-6">
        <p className="text-xs uppercase tracking-[0.24em] text-[var(--color-accent)]">Steg 1</p>
        ...
        <form action={createHouseholdAction} className="mt-5 space-y-3">
          ...
          <FormStatusButton className="action-secondary" pendingLabel="Skapar hushåll...">
            Skapa hushåll
          </FormStatusButton>
        </form>
      </div>
      ...
      <div className="app-panel px-5 py-5 sm:px-6">
        <p className="text-xs uppercase tracking-[0.24em] text-[var(--color-accent)]">Steg 2</p>
        ...
        <form action={joinHouseholdAction} className="mt-5 space-y-3">
          ...
          <FormStatusButton className="action-primary" pendingLabel="Går med...">
            Gå med i hushåll
          </FormStatusButton>
        </form>

        {notice || error ? (
          <p className="muted mt-4 rounded-2xl bg-[color:var(--color-elevated)] px-4 py-3">{error || notice}</p>
        ) : null}
      </div>
    </section>
  );
