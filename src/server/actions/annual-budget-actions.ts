...
export async function saveAnnualBudgetItemAction(formData: FormData) {
  ...
  const parsed = annualBudgetItemSchema.safeParse({
    ...
    savingStartMonth: formData.get("savingStartMonth"),
    dueMonth: formData.get("dueMonth"),
    category: formData.get("category"),
    recurrence: formData.get("recurrence"),
    savingMode: formData.get("savingMode"),
    firstPersonSharePercent: formData.get("firstPersonSharePercent"),
    singleMonthOnly: formData.get("singleMonthOnly") ?? "false",
  ...
  try {
    await upsertAnnualBudgetItemForUser({
      ...
      savingStartMonth: parsed.data.savingStartMonth,
      dueMonth: parsed.data.dueMonth,
      category: parsed.data.category,
      recurrence: parsed.data.recurrence,
      savingMode: parsed.data.savingMode,
      firstPersonSharePercent: parsed.data.firstPersonSharePercent,
      singleMonthOnly: parsed.data.singleMonthOnly,
